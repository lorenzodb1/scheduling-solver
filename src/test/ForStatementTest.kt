...
class ForStatementTest {
    ...
    fun constructForStatement_empty_nodeset() {
        var forString = "FOR \$X IN {} DO SCHEDULE dinner AT 7pm ENDFOR"
    ...
    fun constructForStatement_single_iteration_id_not_used_in_body() {
        var forString = "FOR \$X IN {5pm} DO SCHEDULE dinner AT 7pm ENDFOR"
    ...
    fun constructForStatement_single_iteration_id_used_in_body() {
        var forString = "FOR \$X IN {5pm} DO SCHEDULE dinner AT \$X ENDFOR"
    ...
    fun constructForStatement_single_iteration_id_replaces_description() {
        var forString = "FOR \$X IN {dinner} DO SCHEDULE \$X AT 7pm ENDFOR"
    ...
    fun constructForStatement_multi_character_variable_name() {
        var forString = "FOR \$ABC IN {dinner} DO SCHEDULE \$ABC AT 7pm ENDFOR"
    ...
    fun constructForStatement_multiple_iterations() {
        var forString = "FOR \$X IN {5pm, 6pm} DO SCHEDULE dinner AT \$X ENDFOR"
    ...
    fun constructForStatement_nested_loops() {
        var forString = "FOR \$X IN {5pm, 6pm} DO FOR \$Y IN {dinner, lunch} DO SCHEDULE dinner AT \$X ENDFOR ENDFOR"
        var forStatement = ForStatement(forString);
    ...
    fun constructForStatement_nested_loops_id_shadowed() {
        var forString = "FOR \$X IN {5pm, 6pm} DO FOR \$X IN {3pm, 4pm} DO SCHEDULE dinner AT \$X ENDFOR ENDFOR"
        var forStatement = ForStatement(forString);
    ...
    fun constructForStatement_missing_ENDFOR() {
        var forString = "FOR \$X IN {5pm} DO SCHEDULE dinner AT \$X"
    ...
    fun constructForStatement_missing_FOR() {
        var forString = "\$X IN {5pm} DO SCHEDULE dinner AT \$X ENDFOR"
    ...
    fun constructForStatement_missing_Id() {
        var forString = "FOR IN {5pm} DO SCHEDULE dinner AT \$X ENDFOR"
    ...
    fun constructForStatement_missing_nodeset() {
        var forString = "FOR \$X IN DO SCHEDULE dinner AT \$X ENDFOR"
